...
const DYNAMIC = {
  it: {
    ...
    "suggest.chunked": " I documenti più lunghi sono coperti a blocchi di {chunk} caratteri, con {overlap} di sovrapposizione.",
    ...
    "suggest.streamBroken": "la risposta del modello si e' interrotta prima della fine: nessuna proposta, riprova",
    ...
    "queue.queued": "in attesa",
    "queue.running": "in corso…",
    "queue.done": "fatto",
    "queue.error": "errore",
    "queue.summary": "{done}/{total} file",
    "queue.progress": "coda: {done}/{total}…",
    "queue.finished": "{ok}/{total} anonimizzati",
    "queue.failed": " — {n} falliti",
    "queue.ready": "{n} file in coda",
    "queue.refused": " — {n} oltre il limite, non aggiunti",
  ...
  en: {
    ...
    "suggest.chunked": " Longer documents are covered in chunks of {chunk} characters, with {overlap} of overlap.",
    ...
    "suggest.streamBroken": "the model's answer stopped before the end: no proposals, try again",
    ...
    "queue.done": "done",
    "queue.error": "error",
    "queue.summary": "{done}/{total} files",
    "queue.progress": "queue: {done}/{total}…",
    "queue.finished": "{ok}/{total} anonymized",
    "queue.failed": " — {n} failed",
    "queue.ready": "{n} files queued",
    "queue.refused": " — {n} over the limit, not added",
