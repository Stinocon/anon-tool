...
#
# The download is verified by SIZE and SHA256 before it is put in place: a truncated or substituted
# file would make the panel fail in a way that looks like a configuration problem.
set -euo pipefail
